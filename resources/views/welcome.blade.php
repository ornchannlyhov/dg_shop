    ...
    <style>
        ...
        @media screen and (max-width: 500px) {
            .product-grid {
                ...
                /* Display 2 items per row on phones */
                gap: 10px;
        ...
        .notification {
            ...
            /* Green for success notification */
            color: white;
            padding: 16px;
            border-radius: 5px;
            z-index: 1000;
...
<body>
    ...
    <div class="navbar">
        ...
        <div class="search-container">
            ...
            <button> <svg xmlns="http://www.w3.org/2000/svg" button:hover=" #335c67" width="20" height="20"
                    fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16" background-color="blue">
                    <path
    ...
    <div class="w3-content w3-section" style="max-width:700px; margin: 40px auto;">
        ...
        <img class="mySlides w3-animate-fading"
            src="http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcTVMS9-4HlD7Xk7a8xgT4WBQGv8D1zNAglk_kWBHv10LPhY9ESChgCxC011OMjlfcRIkmLCu46bYf5u3sl-ZHU"
            style="width:100%">
        <img class="mySlides w3-animate-fading"
            src="http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcR039MAfWG3td_9v81sSEYn8U_bdlYuBQ1Gu2WawMolb82IHJUnIMY8Nob-lkyDe6bm-Nl8ozHsADKayLvYnKM"
            style="width:100%">
        <img class="mySlides w3-animate-fading"
            src="http://t3.gstatic.com/licensed-image?q=tbn:ANd9GcQAgfBNw6-wqxp06D8djsYPnrWpVQfsY5IUvEoqKxI5tLd5Krznqd4_ZdGXAKsQtn44nP_CZBE_IjACD_D8jZw"
            style="width:100%">
        <img class="mySlides w3-animate-fading"
            src="http://t0.gstatic.com/licensed-image?q=tbn:ANd9GcQaML4nz1GoCOWzNpV6zImsgKjF4TGIprIyxsEv9hwTouMnjYVuLzdd73zTXQuWHYZcQXX06NhuWocnocLqps4"
            style="width:100%">
    </div>
    ...
    <main>
        ...
        <div class="product-grid" id="product-list">
            <div class="product-card" data-name="Stylish Men's Jacket">
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_LKPI7Ts3G0QP5T65x5vrupH5uybhPSK7uQ&s"
                    alt="Product 1">
